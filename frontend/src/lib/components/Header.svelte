      ...
      {#if showHelp}
        <div class="help-panel">
          ...
          <ol class="help-steps">
            ...
            <li><strong>Clock (audio only)</strong> — When you drop audio on its own, click <strong>Clock</strong> to prepare a delivery "clock": Laybacker checks the file's level (against your NORM target) and that the head and tail are clean, then, on export, adds 10 seconds of silence to the front and 5 seconds to the end. If it isn't quite on spec it tells you the measured level (e.g. "the level is −24 LUFS") and lets you proceed anyway.</li>
